...
class Operation:
    """
    Base class for Usd Optimize python plugin operations.
    ...
    The operation is registered by implementing a global function named `USD_OPTIMIZE_PLUGIN_INIT` that returns an instance of the
    derived operation.
