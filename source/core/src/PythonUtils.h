...
public:
    ...
    ~RefCountedPyObject()
    {
        // I don't love this.... but on Windows when running Usd Optimize from standalone Python, the Python
        // Interpreter is shut down before the static UsdOptimizeCore singleton is destroyed. That means that by the
